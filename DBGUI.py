...
def calculate(*args):
    try:
        ...
        # Convert the result to an integer and add commas
        result = int(result)
...
def update_inputs(*args):
    ...
    # Call the calculate function to update the result immediately
    calculate()

    # Place the result_label at the bottom
...
# Convert the base64-encoded icon data to bytes
...
clear_button.place(relx=0.5, rely=0.8, anchor="center")
